...
import {SortColumn, SortDirection} from '../../locations/location-sort/location-sortable.directive';
...
@Injectable()
export class UserLocationBlacklistService {
  ...
  updateLocationInterfaces() {
    ...
    this.locationService.getUserBlacklist(userId).subscribe(response => {
      ...
      response.forEach(location => {
        ...
        this.authService.user.value.locationBlacklistIds.push(location.id);
      });
    });
  }
